#!/usr/bin/env python3
"""
Script to add hashed passwords to existing users in the database.
This script will update all existing users with a default password.
"""
...
# Default password for all users (change this in production!)
...
if __name__ == "__main__":
    ...
    response = input("\nDo you want to add default passwords to users without passwords? (y/N): ")
